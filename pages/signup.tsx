      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4 relative">
            ...
            <input
              className="pl-10 pr-4 py-3 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 bg-gray-100 text-gray-800"
              id="fullName"
              type="text"
              value={fullName}
          ...
          <div className="flex gap-4 mb-6">
            <button type="button" className="flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2 hover:bg-gray-50 transition text-blue-600">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#1877F3">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            {/* <a href="/login" className="text-pink-500 hover:underline font-medium">Login now</a> */}
